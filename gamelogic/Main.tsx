...
const Main = () => {
  ...
  useEffect(() => {
    ...
    if (GameStatus.isOver === true) {
      //This is for disabling for user to play game anymore after game is over and go back to /game and start again.
    ...
    <>
      <section className={styles.gameContainer}>
        ...
        <canvas
          ...
          width={Setting.field.width}
          height={Setting.field.height}
          ref={tetrisFieldRef}
        ></canvas>
